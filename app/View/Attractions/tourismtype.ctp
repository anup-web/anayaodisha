...
<div class="page-header">
	<div class="page-banner">
		<?php echo $this -> Html -> image('attractions/' . $resultcategory[0]["attraction_category"]["banner_img"], array('alt' => 'Attractions of Odisha', 'fullBase' => true, 'class' => 'img-responsive', 'align' => 'center')); ?>
	</div>
	<div class="page-heading">
		<div class="container">
			<div class="row top-padding bottom-padding">
				<div class="col-md-12">
					<h1><?php echo $resultcategory[0]["attraction_category"]["name"];?></h1>
					<div class="breadcrumbs">
						<p>You are here:</p>
						<ul class="breadcrumb">
							<li><a href="<?php echo $this->Html->url('/');?>">Home</a></li>
							<li><a href="<?php echo $this->Html->url('/attractions');?>">Attractions</a></li>
							<li> <?php echo $resultcategory[0]["attraction_category"]["name"];?> </li>
						</ul>
					</div>
				</div>
			</div>
...
<div class="container">
	<div class="row top-padding-20 bottom-padding-20">
		<div class="col-md-9">
			<div class="row">
				<div class="col-md-12">
					<?php echo $resultcategory[0]["attraction_category"]["description"];?>	
				</div>
			</div>
				...
				<div class="col-md-12">
					...
					<div class="row destination-attractions top-padding top-padding-20">
						...
						<?php
								...
								echo "<div class='col-md-12'><h4>No places found</h4></div>";
							}
						?>
					</div>
				</div>
				...
				<div class="col-md-12 text-center">
					<div class="banner-ad">
						...
						<div class="ad-frame-wrapper">
							<?php echo $this -> Html -> image('ads/72890.jpg', array('alt' => 'Anaya Odisha - Advertisement', 'fullBase' => true, 'class' => 'img-responsive', 'align' => 'center')); ?>
						</div>
					</div>
				</div>
			</div>
