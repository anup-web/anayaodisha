...
<div class="page-header">
	<div class="page-banner">
		<?php echo $this -> Html -> image('pages/railways-to-odisha-landing-banner.jpg', array('alt' => "Railways to Odisha", 'fullBase' => true, 'class' => 'img-responsive', 'align' => 'center')); ?>
	</div>
	<div class="page-heading">
		<div class="container">
			<div class="row top-padding bottom-padding">
				<div class="col-md-12">
					<h1>Railways to Odisha</h1>
					<div class="breadcrumbs">
						<p>You are here:</p>
						<ul class="breadcrumb">
							<li><a href="<?php echo $this->Html->url('/');?>">Home</a></li>
							<li> Railways to Odisha </li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="col-md-9 top-padding">
			<div class="">
				<p>
					...
					Most of the railway network in Odisha lies under the jurisdiction of the East Coast Railway (ECoR) with 
					headquarters at Bhubaneswar and some parts under South Eastern Railway and South East Central Railway.
				</p>
				<p>
